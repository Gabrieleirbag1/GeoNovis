...
@Component({
  selector: 'app-find-country-by-license-plate',
  imports: [CommonModule],
  templateUrl: './find-country-by-license-plate.component.html',
  styleUrls: ['./find-country-by-license-plate.component.css', '../../game/game.component.css'],
  standalone: true
})
export class FindCountryByLicensePlate implements OnInit, OnChanges {
  countries: Country[] = [];
